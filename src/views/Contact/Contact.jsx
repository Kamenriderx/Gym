        ...
        <div className="w-full h-full p-8 ">
          ...
          <div className="h-1/4 ">
            ...
            <div className="w-1/2 p-1 border-2 rounded-md h-1/2 active:border-slate-400 bg-slate-200">
              <input
                type="text"
                className="w-4/6 outline-none h-1/5 bg-slate-200"
                placeholder=""
              />
            </div>
          </div>
          ...
          <div className=" h-3/4">
            <button className="w-1/2 mt-5 font-bold text-white bg-black rounded-md h-1/2">
              Contactanos
            </button>
          </div>
        </div>
